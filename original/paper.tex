...
\begin{itemize}
  \item \texttt{X}: A 3D NumPy array of shape {($N_{windows}$, $N_{channels}$, $N_{bands}$)}, containing the feature vectors in strain$^2$ units, captured by the sensors at each timestamp. 
  \begin{itemize}
