...
E.E.R.-T., S.E.P.-C. J.M.-G., D.P.-P. and J.T. carried out the dataset design, designed the experimental study and performed data processing and model implementation tasks. R.V. coordinated access to the DAS data, metadata and preprocessing scripts. M.R.F.-R., S.M.-L. and M.G.-H. supervised optical sensing and signal interpretation. All authors reviewed and approved the manuscript.
...
This work has been partially supported by the ``Spanish Ministry of Science and Innovation'' MICIU/AEI/10.13039/501100011033, FEDER UE, and by the ``European Union NextGeneration EU/PRTR'' program under grants PSI (PLEC2021-007875), NeurEYE-UAH (PID2024-156576OB-C31), and SEASNAKE+ (PCI2023-145978-2, of the CETPartnership 2022 joint call); by the ``European Innovation Council'' under grant ECSTATIC (101189595);  and by the European Research Council under grant SENSE (101218803). The work of M.R.F-R. was also supported by MCIN/AEI/10.13039/501100011033 and European Union ``NextGenerationEU/PRTR'' under grant RYC2021-032167-I. We gratefully acknowledge the computer resources at Artemisa, funded by the ``European Union ERDF'' and ``Comunitat Valenciana'' as well as the technical support provided by the ``Instituto de Fisica Corpuscular'', IFIC (CSIC-UV). We also thank the cable monitoring operator and the cable owner for allowing data access under confidenciality requirements.
