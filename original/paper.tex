...
\subsection{Geospatial Tagging}
\label{sec:geospatial-tagging}

AQUÍ HABLAR DE INTERPOLACIÓN DE AIS Y DE COMBINACIÓN CON BATIMETRÍA DE EMODNET.
...
\vspace{0.3cm}
\noindent\textbf{Recommended figure:} Figure~4 from the accompanying experimental paper (showing the spatial distribution of vessel passages and the selection of the active segment) should be included here. It clearly illustrates the cable portion used in the dataset and visually supports the data-balance rationale behind the 2553 m selection.
