...
climbing, fiber manipulation, and opening/closing of manholes.

This dataset bridges that gap by releasing the preprocessed, labeled data underpinning one of the largest and most rigorous studies of DAS-based vessel detection and localization conducted to date. It includes 74,771 processed data frames derived from more than 10 days of continuous monitoring, aligned with anonymized AIS-derived proximity information.
