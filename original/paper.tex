...
\todojmg{Erick, check dimensiones please. ship\_info tiene tamaño fijo?... entiendo que también 74771, ¿no?...}
...
\begin{table}[H]
  ...
  \texttt{ship\_info} & AIS metadata (type, length, beam) for the vessel used to generate \texttt{y} labels & 74,771 \\
