...
The good results achieved with our initial experimental approach suggest that the provided data do contain discriminative features for the proposed tasks, being a strong evidence of the dataset's technical validity. We carried out a much more detailed experimental work on this dataset, which is fully described in~\cite{RamirezTorres2026VesselDAS}.
